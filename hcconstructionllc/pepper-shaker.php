...
<html>
<head>
	<title>Pepper Shaker - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">PEPPER SHAKER</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        ...
        <p>Add a modern yet timeless look to your kitchen with Pepper Shaker.<br>With dovetail drawer boxes, full extension glides, and an espresso finish, Pepper Shaker produces a dramatic, contemporary twist to a classic shaker design.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/shaker_collections/pepper_collections/door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/pepper_collections/a2.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/pepper_collections/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/pepper_collections/a3.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/pepper_collections/portada/3.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/pepper_collections/a4.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/pepper_collections/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/pepper_collections/a5.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/pepper_collections/portada/5.jpg" alt="" /></a>
			</li>
        </div>
    </div>
