...
<html>
<head>
	<title>Gramercy White - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">GRAMERCY WHITE</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Gramercy White</h3>
        <p class="align-top">The Gramercy collection’s crisp raised panel design is versatile and timeless, with results that are limited only by the imagination.</p>
        <p>The Gramercy style cabinetry’s raised panel design, dovetail drawer boxes, full extension soft closing drawers, and soft closing doors transform your kitchen into a place of comfort and sophistication.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/gramercy_collections/Door1.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/gramercy_collections/a1.jpg"><img  style="width:100%"  src="images/cabinets/gramercy_collections/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/gramercy_collections/a2.jpg"><img  style="width:100%" src="images/cabinets/gramercy_collections/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/gramercy_collections/a3.jpg"><img  style="width:100%" src="images/cabinets/gramercy_collections/portada/3.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/gramercy_collections/a4.jpg"><img  style="width:100%" src="images/cabinets/gramercy_collections/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/gramercy_collections/a5.jpg"><img  style="width:100%" src="images/cabinets/gramercy_collections/portada/5.jpg" alt="" /></a>
			</li>
        </div>
    </div>
