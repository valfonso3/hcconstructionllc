...
<html>
<head>
	<title>Signature Pearl - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">SIGNATURE PEARL</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Signature Pearl</h3>
        <p class="align-top">Whether your perfect setting is classic comfort or sophisticated refinement, the Signature collection’s raised panel design and antique glazing detail serves as the ideal choice to create the dream kitchen.</p>
        <p>Combine tradition with the feel of modern luxury. Whether your fantasy is classic comfort or sophisticated refinement, Signature Pearl’s raised panel design and antique white color serve as the ideal choice to create the perfect setting for your dream kitchen.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/signature_collections/signature_pearl/Door1.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_pearl/a1.jpg"><img  style="width:100%"  src="images/cabinets/signature_collections/signature_pearl/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_pearl/a2.jpg"><img  style="width:100%"  src="images/cabinets/signature_collections/signature_pearl/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
