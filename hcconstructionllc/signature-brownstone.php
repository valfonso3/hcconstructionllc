...
<html>
<head>
	<title>Signature Brownstone - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">SIGNATURE BROWNSTONE</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Signature Brownstone</h3>
        <p class="align-top">Whether your perfect setting is classic comfort or sophisticated refinement, the Signature collection’s raised panel design and antique glazing detail serve as the ideal choice to create the dream kitchen.</p>
        <p>Signature Brownstone cabinets feature a classic raised panel design with rich brown notes, to bring both warmth and elegance to your home. Constructed with dovetail drawer boxes and full extension soft closing drawers, Signature Brownstone is as functional and durable as it is beautiful.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/signature_collections/signature_brownstone/Door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_brownstone/a1.jpg"><img  style="width:100%"  src="images/cabinets/signature_collections/signature_brownstone/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_brownstone/a2.jpg"><img  style="width:100%" src="images/cabinets/signature_collections/signature_brownstone/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_brownstone/a3.jpg"><img  style="width:100%" src="images/cabinets/signature_collections/signature_brownstone/portada/3.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_brownstone/a4.jpg"><img  style="width:100%" src="images/cabinets/signature_collections/signature_brownstone/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/signature_collections/signature_brownstone/a5.jpg"><img  style="width:100%" src="images/cabinets/signature_collections/signature_brownstone/portada/5.jpg" alt="" /></a>
			</li>
        </div>
    </div>
