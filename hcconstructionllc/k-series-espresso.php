...
<html>
<head>
	<title>K-Series Espresso - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">K-SERIES ESPRESSO</h1>
...
<section>
  ...
  <div class="row cabinets">
    ...
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/k_series_collections/k_series_espresso/Door.png">
        </center>
    </div>
    </div>
    </div>
