...
<html>
<head>
	<title>K-Series Cinnamon Glaze - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">K-SERIES CINNAMON GLAZE</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>K-Series Cinnamon Glaze</h3>
        <p class="align-top">K-Series collection merges a traditional door profile with a versatile color palette to suit any home.</p>
        <p>The K-Series from Forevermark Cabinetry is available in Cherry Glaze, Cinnamon Glaze, Honey, Espresso, and White.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/Door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/k_series_collections/k_series_cinnamon_glaze/a1.jpg"><img  style="width:100%"  src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/k_series_collections/k_series_cinnamon_glaze/a2.jpg"><img  style="width:100%" src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/k_series_collections/k_series_cinnamon_glaze/a3.jpg"><img  style="width:100%" src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/portada/3.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/k_series_collections/k_series_cinnamon_glaze/a4.jpg"><img  style="width:100%" src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/k_series_collections/k_series_cinnamon_glaze/a5.jpg"><img  style="width:100%" src="images/cabinets/k_series_collections/k_series_cinnamon_glaze/portada/5.jpg" alt="" /></a>
			</li>
        </div>
    </div>
