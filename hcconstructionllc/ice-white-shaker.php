...
<html>
<head>
	<title>Ice White Shaker - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">ICE WHITE SHAKER</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        ...
        <p>Ice White Shaker cabinets can make any kitchen look larger and brighter. Its clean and simple design pairs well with any layout or color scheme, and is adaptable enough for use in both traditional and modern homes.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/shaker_collections/ice_white_shaker/Door.jpg">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/ice_white_shaker/a1.jpg"><img  style="width:100%"  src="images/cabinets/shaker_collections/ice_white_shaker/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/ice_white_shaker/a2.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/ice_white_shaker/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/ice_white_shaker/a3.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/ice_white_shaker/portada/3.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/ice_white_shaker/a4.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/ice_white_shaker/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/shaker_collections/ice_white_shaker/a5.jpg"><img  style="width:100%" src="images/cabinets/shaker_collections/ice_white_shaker/portada/5.jpg" alt="" /></a>
			</li>
        </div>
    </div>
