...
<html>
<head>
	<title>Townsquare Grey - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">TOWNSQUARE GREY</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Townsquare Grey</h3>
        <p class="align-top">The Town series combines a lasting design with subtle detailing for a truly simple yet elegant look.</p>
        <p>Simple yet elegant, the Town series cabinetry combine a classic design with subtle detailing, along with dovetail drawer boxes, full extension soft closing drawers, and soft closing doors.<br>
</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/town_collections/townsquare_grey/Door.png">
        </center>
    </div>
    </div>
    </div>
