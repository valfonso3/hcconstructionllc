...
<html>
<head>
	<title>Pacifica - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">PACIFICA</h1>
...
<section>
  ...
  <div class="row cabinets">
    ...
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/pacifica/Door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/pacifica/a1.jpg"><img  style="width:100%"  src="images/cabinets/pacifica/a1.jpg" alt="" /></a>
			</li>
    </div>
