...
<html>
<head>
	<title>Uptown White - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">UPTOWN WHITE</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Uptown White</h3>
        <p class="align-top">The Town series combines a lasting design with subtle detailing for a truly simple yet elegant look.</p>
        <p>Simple yet elegant, the Town series cabinetry combine a classic design with subtle detailing, along with dovetail drawer boxes, full extension soft closing drawers, and soft closing doors.</p>
        
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/town_collections/uptown_white/puerta.jpg">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/town_collections/uptown_white/a1.jpg"><img  style="width:100%"  src="images/cabinets/town_collections/uptown_white/a1.jpg" alt="" /></a>
			</li>
    </div>
