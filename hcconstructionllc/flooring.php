...
<head>
     ...
     <title>HC Construction - Flooring</title>
...
?>
        ...
        <ul class="menu1 clearfix navi col-md-12 col-xs-12" style="max-width:960px; margin:0 auto;">
          ...
          <li class="dropdown"><a target="" class="transformar active dropdown-toggle" data-toggle="dropdown" href="#" >Portfolio <i class="fa fa-angle-down"></i></a>
          	<ul class="dropdown-menu">
                ...
                <li class="dpdw"><a class="transformar active sub" href="flooring.php">Flooring</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">FLOORING</h1>
                                    <h4 style="color:#fff;">See all Flooring</h4>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<section style="margin-top: 80px;">
		...
		<ul class="caption-style-4">
			<li class="hola">
				<a href="javascript:;" id="flo_andre_robert">
					<img src="images/gallery/captions/flo_andre_robert.jpg" alt="">
				<div class="caption">
					<div class="blur"></div>
					<div class="caption-text">
						<h1>Andre Robert</h1>
						<p style="color:#fff;">(Ahsburn VA)</p>
					</div>
				</div></a>
			</li>
			<li>
				<a href="javascript:;" id="flo_hamed_rod">
				<img src="images/gallery/captions/flo_hamed_rod.jpg" alt="">
				<div class="caption">
					<div class="blur"></div>
					<div class="caption-text">
						<h1>Hamed Rod</h1>
			...
			<li>
				<a href="javascript:;" id="flo_hard_floorR">
				<img src="images/gallery/captions/flo_hard_floorR.jpg" alt="">
				<div class="caption">
					<div class="blur"></div>
					<div class="caption-text">
						<h1>Hardwood</h1>
