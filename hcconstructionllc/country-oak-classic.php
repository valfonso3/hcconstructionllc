...
<html>
<head>
	<title>Country Oak Classic - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">COUNTRY OAK CLASSIC</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Country Oak Classic</h3>
        <p class="align-top">For a traditional style that works in any home, Contry Oak Classic is the perfect match for those who appreciate the natural beauty of wood cbinetry. Oak cabinetry has long been treasured for its durability and versatility.</p><p>Featuring a five-piece header and raised panel doors, Country Oak Classic puts a spin on a time-honored classic design</p>
        
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/country_oak_clasic/door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/country_oak_clasic/1.jpg"><img  style="width:100%"  src="images/cabinets/country_oak_clasic/1.jpg" alt="" /></a>
			</li>
    </div>
