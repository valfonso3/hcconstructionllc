...
<html>
<head>
	<title>Sienna Rope - HC Construction LLC</title>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div>
                                    <h1 style="color:#fff; font-size: 34px;">SIENNA ROPE</h1>
...
<section>
  ...
  <div class="row cabinets">
      <div class="col-sm-8 ">
        <h3>Sienna Rope</h3>
        <p class="align-top">A uniquely refined ccabinet style, Sienna Rope will take your kitchen to extraordinary heights. Sienna Rope is designed with a distinct finish, and engineered with full extension soft closing drawers and dovetail drawer boxes.</p>
        <p>Its delicate rope trim and glazing detail accenuates the craftmanship od each cabinet.
Make your kitchen your home's main attraction with Sienna Rope.</p>
    </div>
    <div class="col-sm-4">
        <center>
        <img src="images/cabinets/sienna_rope/Door.png">
        </center>
    </div>
    </div>
    </div>
...
<section>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/sienna_rope/a1.jpg"><img  style="width:100%"  src="images/cabinets/sienna_rope/portada/1.jpg" alt="" /></a>
			</li>
    </div>
    <div class="col-sm-6 col-xs-12" style="padding:0;">
        ...
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/sienna_rope/a2.jpg"><img  style="width:100%" src="images/cabinets/sienna_rope/portada/2.jpg" alt="" /></a>
			</li>
        </div>
        <div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/sienna_rope/a3.jpg"><img  style="width:100%" src="images/cabinets/sienna_rope/portada/3.jpg" alt="" /></a>
			</li>
        </div>
    <!--<div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
				<a class="fancybox-buttons" data-fancybox-group="button" href="images/cabinets/sienna_rope/a4.jpg"><img  style="width:100%" src="images/cabinets/sienna_rope/portada/4.jpg" alt="" /></a>
			</li>
        </div>
        div class="col-sm-6 col-xs-12" style="padding:0;">
            <li class="hola" >
